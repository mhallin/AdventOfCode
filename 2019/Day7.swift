...
func runFeedbackAmplifierSequence(data: [Int64], phases: [Int64]) -> Int64 {
    var output = Int64(0)
...
func findMaxSequence(data: [Int64], from: Int64, to: Int64, by: ([Int64], [Int64]) -> Int64) -> ([Int64], Int64) {
    var max = Int64(0)
    var maxSequence = [Int64(0), Int64(0), Int64(0), Int64(0), Int64(0)]
    for a in from...to {
        for b in from...to {
            if b == a {
                continue
